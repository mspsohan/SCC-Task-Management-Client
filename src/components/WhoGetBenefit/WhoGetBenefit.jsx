...
const UsersAndBenefits = () => {
	...
	return (
		<>
			{/* <div className='flex items-center my-12 justify-center bg-gray-100 overflow-hidden'>
				<div className='px-4 py-10 mx-auto lg:py-20 max-w-7xl'>
					<div className='max-w-xl mx-auto'>
						<h1 className='mb-4 text-4xl font-bold text-center '>
							See Who Used This Application
						</h1>
					...
					<div className='grid grid-cols-1 gap-4 lg:gap-8 md:grid-cols-2 lg:grid-cols-3'>
						...
						<motion.div
							...
							<p className='text-base text-gray-500 -400'>
								Track project progress, assign tasks, and collaborate with teams
								effectively.
							</p>
						</motion.div>
						<motion.div
			...
			{/* benefit Section */}
			<div className='flex items-center my-12 justify-center bg-gray-200 overflow-hidden'>
				<div className='px-4 py-10 mx-auto lg:py-20 max-w-7xl'>
					<div className='max-w-xl mx-auto'>
						<h1 className='mb-4 text-4xl font-bold text-center '>
						...
						<p className='mb-16 text-base text-center text-gray-500'>
							Elevate productivity for developers, professionals, bankers & more with our
							versatile task management app. Simplify your workflow today!
						</p>
					</div>
					<div className='grid grid-cols-1 gap-4 lg:gap-8 md:grid-cols-2 lg:grid-cols-3'>
						<motion.div
