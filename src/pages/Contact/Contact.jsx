...
const Contact = () => {
	return (
		<>
			<div className='flex items-center bg-zinc-100 font-poppins  '>
				<div className='max-w-6xl px-4 py-4 mx-auto lg:py-11 md:px-6'>
					<div className='mb-20 text-center pb-7'>
						...
						<p className='text-sm text-gray-600'>
							Manage your tasks efficiently with our user-friendly task management app. Stay
							on top of your to-do list, prioritize tasks, and track your progress
							seamlessly.
						</p>
					</div>
					...
					<div className='flex flex-wrap mb-6'>
						<div className='w-full px-4 mb-20 lg:w-1/3 lg:mb-0'>
							<motion.div
								...
								className='relative h-full px-6 pt-20 pb-12 text-center shadow bg-gray-50 '>
								<div className='absolute top-0 inline-flex items-center justify-center w-20 h-20 text-blue-600 transform -translate-x-1/2 -translate-y-1/2 bg-blue-100 border border-blue-600 rounded-full    left-1/2 '>
									<svg
						...
						<motion.div
							...
							<div className='relative h-full px-6 pt-20 pb-12 text-center shadow bg-gray-50 '>
								...
								<h3 className='mb-6 text-lg font-medium '></h3>
								<p className='text-xl text-gray-500 sm:text-2xl '>+880-1234567890</p>
							</div>
						</motion.div>
						<motion.div
							whileHover={{ scale: 1.2 }}
							...
							<div className='relative h-full px-6 pt-20 pb-12 text-center shadow bg-gray-50 '>
								...
								<h3 className='mb-6 text-lg font-medium '></h3>
								<p className='text-xl text-gray-500 sm:text-2xl '>Dhaka, Bangladesh</p>
							</div>
						</motion.div>
					</div>
						...
						<form action='' className='py-6 rounded shadow  bg-gray-50'>
							<div className='flex flex-wrap '>
								...
								<div className='w-full px-3 md:w-1/2 md:mb-0'>
									...
									<input
										...
										required
										className='block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-100 border rounded     '
									/>
								</div>
								<div className='w-full px-3 md:w-1/2 md:mb-0'>
									<label
							...
							<div className='px-3 mb-6'>
								...
								<textarea
									...
									required
									className='block w-full px-4 py-10 leading-tight text-gray-700 bg-gray-100 rounded     '></textarea>
							</div>
							<div className='px-6'>
								<button className='px-4 py-2 font-medium text-gray-100 bg-blue-600 rounded shadow hover:bg-blue-700  -700'>
									Send Message
								</button>
							</div>
						</form>
