...
const ErrorPage = () => {
   return (
      <>
         <div className="bg-blue-100 md:h-screen font-poppins  ">
               ...
               <div className="justify-center max-w-6xl px-4 mx-auto text-center ">
                  <div className="w-full p-8 bg-white rounded-md ">
                     <div className="hidden w-full mb-6 xl:block lg:block">
                        <img src="https://i.postimg.cc/qqVRfZbf/pexels-tim-gouw-52608.jpg" alt=""
                           className="relative inset-0 object-cover w-full rounded-md h-34 lg:h-64" />
                     </div>
                     <h1
                        className="inline-block mb-5 font-bold text-gray-700 text-7xl xl:text-9xl lg:text-9xl dark:text-gray-300">
                        404
                     </h1>
